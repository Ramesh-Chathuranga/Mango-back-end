...
var userDispatcher = express_1.default.Router();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userRepository_1.default.updateData(body, body.uid)];
            case 1:
                data = _a.sent();
...
userDispatcher.route("/:id")
    .get(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var uid, data, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                uid = req.params.id;
                return [4 /*yield*/, userRepository_1.default.getAUser(uid)];
            case 1:
                data = _a.sent();
                res.status(200).json(data);
                return [3 /*break*/, 3];
